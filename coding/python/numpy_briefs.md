...
| `uint`            | `unsigned long`      | `uint64`、`uintp`     | `L`        | `u8`                        |
...
| `clongdouble`     | `long double complex` | `complex256`          | `G`        | `c32`                       | 两个扩展精度浮点       | `clongfloat`、`longcomplex` |
...
| Routine                                            | Function Version                                               |
|----------------------------------------------------|----------------------------------------------------------------|
| `np.arange([start,]stop[,step][,dtype])`           | 给定间距跳分                                                   |
